...
<!-- 	<li><a href='pendaftaran/' title='Pendaftaran Pasien' target='_blank'><i class="fa fa-pencil-square fa-fw"></i> Pendaftaran Pasien</a> </li> -->
	...
	<li><a href='rawat-pasien/' title='Rawat Pasien' target='_blank'><i class="fa fa-share-square fa-fw"></i>Pembayaran Pasien</a> </li>
<!-- 	<li><a href='penjualan/' title='Penjualan Apotek' target='_blank'><i class="fa fa-laptop fa-fw"></i>Pengambilan Resep Obat</a> </li> -->
...
<!--             <li><a href="?page=Laporan-Petugas">Laporan Data Petugas</a></li>
			...
			<li><a href="?page=Laporan-Rawat">Laporan Rekam Medik Pasien/Diagnosa</a></li>
			<li><a href="?page=Laporan-Rawat-Periode">Laporan Rekam Medik/Periode</a></li>
			<li><a href="?page=Laporan-Pendaftaran">Laporan Rekam Medik/Tindakan</a></li>
			
			<li><a href="?page=Laporan-Penjualan">Laporan Pembayaran Obat</a></li>
			<li><a href="?page=Laporan-Penjualan-Periode">Laporan Pembayaran Obat/Periode</a></li>
        </ul>
        <!-- /.nav-second-level -->
    </li>
...
<ul class="nav" id="side-menu">
	...
	i<li><a href="?page=Laporan-Pendaftaran">Laporan Pendaftaran</a></li>
...
<ul class="nav" id="side-menu">
	<li><a href='?page' title='Halaman Utama'>Home</a></li>
	<li><a href='penjualan/index.php' title='Penjualan Apotek' target='_blank'>Pengambilan Resep Obat</a> </li>
	<li><a href='?page=Logout' title='Logout (Exit)'>Logout</a></li>
</ul>
...
elseif(isset($_SESSION['SES_PASIEN'])){
# JIKA YANG LOGIN LEVEL KASIR APOTEK, menu di bawah yang dijalankan
?>
<div class="navbar-default sidebar" role="navigation">
  <div class="sidebar-nav navbar-collapse">
