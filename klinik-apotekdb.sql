...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Des 2018 pada 17.42
...
('RM0013', 'Zuliana Sandra', '12662865256', 'Perempuan', 'A', 'Islam', 'Tanggerang', '1998-07-27', '021', 'op', 'Menikah', 'Pegawai Negri Sipil(PNS)', 'Saudara', 'asdfghjkl', '022', '2018-11-25', 'P001'),
('RM0014', 'Sageri Fikri Ramadhan', '317409070', 'Laki-laki', 'B', 'Islam', 'Jakarta', '1999-01-07', '08138173', 'Jakarta', 'Belum Nikah', 'Wiraswasta', 'Saudara', 'Deandra Abiantoro', '08571234', '2018-11-29', 'P004');
...
('0000014', 'RM0013', '2018-11-29', '2018-11-29', '12:20:00', 'Sakit Sariawan', 'T001', '', 1, 'P002'),
...
('JL00010', '2018-11-29', 'Zuliana Sandra', 'Encok', 75000, 'P003'),
('JL00011', '2018-11-29', 'Sageri Fikri Ramadhan', 'Sakit Gigi', 140000, 'P003'),
('JL00012', '2018-12-01', '', '', 60000, 'P003');
...
--
ALTER TABLE `rawat_tindakan`
  MODIFY `id_tindakan` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
COMMIT;
