                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">Tindakan Medis</div>
                                    <div>Tambah Data</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">Rekam Medik</div>
                                    <div>Lihat data</div>
                                </div>
                            </div>
                        </div>
                        <a href="?page=Laporan-Pendaftaran/">
                            <div class="panel-footer">
                                <span class="pull-left">Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
...
else if(isset($_SESSION['SES_PASIEN'])) {
?>
...
<h4>Selamat datang di Klinik & Apotek</h4></b><br/>
	...
	?>
	<br><br><br>
	<img src="./images/logo.png" width="650px" style="setImageOpacity(3.3);">
	<br><br>
	<h2>Selamat datang di Klinik & Apotek </h2>";
